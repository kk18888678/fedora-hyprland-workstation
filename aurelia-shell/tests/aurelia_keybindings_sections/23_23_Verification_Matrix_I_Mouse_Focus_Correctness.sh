...
row_qml="$ROOT/components/keybindings/KeybindingRow.qml"
...
if grep -q 'id: outsideDismissArea' "$ROOT/components/keybindings/KeybindingsWindow.qml" && \
   grep -q 'windowRoot.visible = false' "$ROOT/components/keybindings/KeybindingsWindow.qml" && \
   grep -q 'anchors.centerIn: parent' "$ROOT/components/keybindings/KeybindingsWindow.qml"; then
