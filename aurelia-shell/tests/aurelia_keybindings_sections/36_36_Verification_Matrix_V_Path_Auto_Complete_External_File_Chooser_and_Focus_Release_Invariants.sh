...
if ! grep -q 'import QtQuick\.Dialogs' "$ROOT/components/keybindings/KeybindingsWindow.qml"; then
...
if ! grep -q 'FileDialog {' "$ROOT/components/keybindings/KeybindingsWindow.qml"; then
...
if grep -q 'property bool browseActive:' "$ROOT/components/keybindings/KeybindingsWindow.qml"; then
...
if grep -q 'windowRoot\.browseActive ? WlrKeyboardFocus\.None' "$ROOT/components/keybindings/KeybindingsWindow.qml"; then
...
if grep -q '!windowRoot\.browseActive && windowRoot\.isRecording' "$ROOT/components/keybindings/KeybindingsWindow.qml"; then
...
if grep -q 'AURELIA_DEVELOPMENT_MODE' "$ROOT/components/keybindings/KeybindingsModel.qml" && \
   grep -q 'AURELIA_SHELL_KEYBINDINGS_BIN' "$ROOT/components/keybindings/KeybindingsModel.qml" && \
   grep -q '/usr/local/bin/aurelia-shell-keybindings' "$ROOT/components/keybindings/KeybindingsModel.qml" && \
   grep -q 'anchors.top: parent.bottom' "$ROOT/components/keybindings/KeybindingsExecutableForm.qml" && \
   ! grep -q 'anchors.top: pathInputContainer.bottom' "$ROOT/components/keybindings/KeybindingsExecutableForm.qml" && \
   ! grep -q '/\.local/bin/' "$ROOT/components/keybindings/KeybindingsModel.qml"; then
...
if grep -q 'property var pathCompletions:' "$ROOT/components/keybindings/KeybindingsModel.qml" && \
   grep -q 'function fetchPathCompletions(' "$ROOT/components/keybindings/KeybindingsModel.qml"; then
