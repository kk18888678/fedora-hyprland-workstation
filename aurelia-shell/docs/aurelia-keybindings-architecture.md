...
Aurelia Keybindings serves as the reference implementation for the **Universal Aurelia Plugin Contract** defined in [`aurelia-shell-architecture.md`](aurelia-shell-architecture.md).
