-- Hyprland color integration for Noctalia.
--
-- This file provides a deterministic fallback palette so Hyprland
-- can start before Noctalia has generated theme colors.
--
-- Noctalia integration may update these values later.
