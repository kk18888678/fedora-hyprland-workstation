...
QtObject {
    ...
    readonly property color border: colors["inactive_border_color"] || "#424659"
    readonly property color borderActive: colors["active_border_color"] || "#5fd4fd"
    ...
    readonly property color foam: colors["color4"] || "#9ccfd8"
    readonly property color rose: colors["color5"] || "#ea9a97"
    readonly property color iris: colors["color13"] || "#c4a7e7"
