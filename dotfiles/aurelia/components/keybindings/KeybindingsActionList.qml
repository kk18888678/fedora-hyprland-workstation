...
Item {
    ...
    readonly property bool listVisible: modelController.activeView !== "add_exec" && modelController.activeView !== "settings"
    visible: listVisible
    ...
    Text {
        ...
        text: (actionListRoot.modelController.activeView === "add_app") ? (actionListRoot.modelController.isLoadingApps ? "Discovering installed applications..." : "No matching applications found") : ((actionListRoot.modelController.activeView === "add_action_type") ? "No action types available" : (actionListRoot.modelController.activeView === "unbound" ? ("No unbound shortcuts (press " + Theme.shortcutAddAction + " to add an action)") : "No matching shortcuts"))
        color: Theme.textSubtle
        font.family: Theme.fontFamily
        font.pixelSize: Theme.fontSizeSm
        visible: actionListRoot.modelController.filteredItems.length === 0 && (actionListRoot.modelController.activeView === "bound" || actionListRoot.modelController.activeView === "unbound" || actionListRoot.modelController.activeView === "add_action_type" || actionListRoot.modelController.activeView === "add_app")
    }
}
