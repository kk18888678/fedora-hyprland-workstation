...
run_suite "$ROOT/tests/test_browsers.sh"
run_suite "$ROOT/tests/test_flatpak.sh"
run_suite "$ROOT/tests/test_containers.sh"
...
run_suite "$ROOT/tests/test_zsh_history.sh"
run_suite "$ROOT/tests/test_crash_capture.sh"
