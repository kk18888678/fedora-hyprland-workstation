...
if grep -q 'singleton KeybindingsConfig 1.0 KeybindingsConfig.qml' "$ROOT/dotfiles/aurelia/components/keybindings/qmldir" && \
   ...
   grep -q 'KeybindingRow 1.0 KeybindingRow.qml' "$ROOT/dotfiles/aurelia/components/keybindings/qmldir" && \
   grep -q 'KeybindingsHeader 1.0 KeybindingsHeader.qml' "$ROOT/dotfiles/aurelia/components/keybindings/qmldir" && \
   grep -q 'KeybindingsActionList 1.0 KeybindingsActionList.qml' "$ROOT/dotfiles/aurelia/components/keybindings/qmldir" && \
   grep -q 'KeybindingsExecutableForm 1.0 KeybindingsExecutableForm.qml' "$ROOT/dotfiles/aurelia/components/keybindings/qmldir" && \
   grep -q 'KeybindingsFooter 1.0 KeybindingsFooter.qml' "$ROOT/dotfiles/aurelia/components/keybindings/qmldir"; then
...
if grep -q 'function ping(): string' "$ROOT/aurelia-shell/shell.qml" && \
   grep -q 'function summon(pluginId: string, payloadJson: string): string' "$ROOT/aurelia-shell/shell.qml" && \
   grep -q 'function hide(pluginId: string): string' "$ROOT/aurelia-shell/shell.qml" && \
   grep -q 'function toggle(pluginId: string, payloadJson: string): string' "$ROOT/aurelia-shell/shell.qml" && \
   grep -q 'function call(pluginId: string, method: string, argument: string): string' "$ROOT/aurelia-shell/shell.qml" && \
   grep -q 'function rescanPlugins(): string' "$ROOT/aurelia-shell/shell.qml" && \
   grep -q 'function setPluginEnabled(pluginId: string, enabled: string): string' "$ROOT/aurelia-shell/shell.qml" && \
   grep -q 'function listPlugins(): string' "$ROOT/aurelia-shell/shell.qml"; then
